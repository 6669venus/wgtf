...
<head>
	...
	<script type="text/javascript">
		...
		function makeDataTable( opts,options )
		{
			...
			document.getElementById("bot_bar_date").innerHTML = "<font color=" + greyColor + " size = '10'> since " + jsonData.dateMin[0] +  "/" + jsonData.dateMin[1] + " - " + + jsonData.dateMax[0] +  "/" + jsonData.dateMax[1];
...
<body onload="changeBackground('black');">
	<div class="chart-category">
		...
		<div class ="frames topbar" style="width:98.5%;height:44px; padding-bottom:16px;">
			<span id="bot_bar_title"> &nbsp;Ruinberg 15_1 </span>
