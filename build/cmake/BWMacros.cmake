...
MACRO( BW_ADD_EXECUTABLE _PROJNAME )
	...
	IF( BW_IS_SERVER )
		ADD_CUSTOM_COMMAND(
			...
			COMMAND python ${NGT_SOURCE_DIR}/build/replace_build_date.py $<TARGET_FILE:${_PROJNAME}>
...
MACRO( BW_CHECK_REMOTE_BUILD _PROJNAME )
	STRING( REPLACE "${NGT_SOURCE_DIR}/" "" _PROJ_PATH "${CMAKE_CURRENT_LIST_DIR}/" )
	...
	IF (EXISTS "${NGT_SOURCE_DIR}/${_PROJ_PATH}/Makefile.rules" OR ${_PROJNAME} MATCHES "BUILD_SERVER" )
