...
FUNCTION( BW_SET_BINARY_DIR _PROJNAME _DIRNAME )
	SET(RUNTIME_ATTRIBUTE "RUNTIME_OUTPUT_DIRECTORY")
	SET(PDB_ATTRIBUTE "PDB_OUTPUT_DIRECTORY")

	IF (BW_PLATFORM_MAC)
		SET(RUNTIME_ATTRIBUTE "LIBRARY_OUTPUT_DIRECTORY")
	ENDIF()

	FOREACH(CONFIGURATION ${CMAKE_CONFIGURATION_TYPES})
		string( TOUPPER ${CONFIGURATION} CONFIGURATION )
		SET_TARGET_PROPERTIES( ${_PROJNAME} PROPERTIES
			${RUNTIME_ATTRIBUTE}_${CONFIGURATION} "${_DIRNAME}"
			${PDB_ATTRIBUTE}_${CONFIGURATION} "${_DIRNAME}")
	ENDFOREACH()
...
FUNCTION( BW_COPY_PLUGIN_TO_BUNDLE _FROM_TARGET)
	...
	ADD_CUSTOM_COMMAND(
		...
		COMMAND ${CMAKE_COMMAND} -E copy_if_different
			$<TARGET_FILE:${_FROM_TARGET}>
			${EXE_DIR}/${BW_BUNDLE_NAME}$<$<CONFIG:Debug>:_d>.app/Contents/PlugIns/plugins/$<TARGET_FILE_NAME:${_FROM_TARGET}>
		COMMENT "Copying from ${_FROM_TARGET} to ${EXE_DIR}/${BW_BUNDLE_NAME}_d.app/Contents/PlugIns/plugins."
		VERBATIM
	)
ENDFUNCTION()
