...
FUNCTION( BW_SET_BINARY_DIR _PROJNAME _DIRNAME )
	...
	IF (BW_PLATFORM_MAC)
		SET_TARGET_PROPERTIES( ${_PROJNAME} PROPERTIES
			LIBRARY_OUTPUT_DIRECTORY_DEBUG "${_DIRNAME}/${BW_BUNDLE_NAME}_d.app/Contents/PlugIns"
			PDB_OUTPUT_DIRECTORY_DEBUG "${_DIRNAME}"
		)
		SET_TARGET_PROPERTIES( ${_PROJNAME} PROPERTIES
			LIBRARY_OUTPUT_DIRECTORY_HYBRID "${_DIRNAME}/${BW_BUNDLE_NAME}.app/Contents/PlugIns"
			PDB_OUTPUT_DIRECTORY_HYBRID "${_DIRNAME}"
		)
		SET_TARGET_PROPERTIES( ${_PROJNAME} PROPERTIES
			LIBRARY_OUTPUT_DIRECTORY_CONSUMER_RELEASE "${_DIRNAME}/${BW_BUNDLE_NAME}.app/Contents/PlugIns"
			PDB_OUTPUT_DIRECTORY_CONSUMER_RELEASE "${_DIRNAME}"
		)
	ENDIF()
