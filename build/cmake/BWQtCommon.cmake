...
# Append Qt debug flags to all projects
# Debug and Hybrid, but not Release
# *Do not* use QT_QML_DEBUG_NO_WARNING
SET( CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -DQT_DECLARATIVE_DEBUG -DQT_QML_DEBUG -DQT_QML_DEBUG_NO_WARNING" )
SET( CMAKE_CXX_FLAGS_HYBRID "${CMAKE_CXX_FLAGS_HYBRID}  -DQT_QML_DEBUG -DQT_QML_DEBUG_NO_WARNING" )
