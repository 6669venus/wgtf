...
# Required by timestamp.hpp in libcstdmf: and thus needed by almost
# every binary.
...
cppFlags_$(bwConfBinName) += -Wno-ignored-qualifiers -Wno-unused-variable -Wno-unused-local-typedefs
...
$(objectDirectories): $(BW_PLATFORM_BUILD_SENTINEL)
	@mkdir -p $@
