...
# cause a failure.
$(PYTHON_BUILD_DIR): $(BW_PLATFORM_BUILD_SENTINEL)
	@mkdir -p $@
...
.PHONY: host_python_install
host_python_install: $(PythonPostInstallSentinel)
$(pythonInstallBinaryTarget): $(PythonPostInstallSentinel)

.PHONY: host_bw_python_modules
host_bw_python_modules:
	@+$(call hostSubBuild, $(BW_ABS_SRC), $(BW_PYTHON_MODULES))

$(PythonPostInstallSentinel):
	@+$(call hostSubBuild, $(BW_ABS_SRC), python_install)
