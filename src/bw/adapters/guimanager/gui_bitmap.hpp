...
protected:
	...
	bool defaultSize_;
public:
	Bitmap( const BW::wstring& name, unsigned long transparent, const BW::string& type = "NORMAL", unsigned int width = SIZE_DEFAULT, unsigned int height = SIZE_DEFAULT );
	~Bitmap();
...
public:
	...
	BitmapPtr get( const BW::string& name, unsigned long transparent,
