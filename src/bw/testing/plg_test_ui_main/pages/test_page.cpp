...
void TestPage::setVector3( const BW::Vector3 & vec3 )
{
	vec3_.x = vec3.x;
	vec3_.y = vec3.y;
	vec3_.z = vec3.z;
}
void TestPage::getVector3( BW::Vector3 * vec3 ) const
{
	vec3->x = vec3_.x;
	vec3->y = vec3_.y;
	vec3->z = vec3_.z;
...
void TestPage::setVector4( const BW::Vector4 & vec4 )
{
	vec4_.x = vec4.x;
	vec4_.y	= vec4.y;
	vec4_.z = vec4.z;
...
void TestPage::getVector4( BW::Vector4 * vec4 ) const
{
	vec4->x = vec4_.x;
	vec4->y = vec4_.y;
	vec4->z = vec4_.z;
...
void TestPage::setColor3( const BW::Vector3 & color )
{
	color3_.x = color.x;
	color3_.y = color.y;
	color3_.z = color.z;
}
void TestPage::getColor3( BW::Vector3 * color ) const
{
	color->x = color3_.x;
	color->y = color3_.y;
	color->z = color3_.z;
...
void TestPage::setColor4( const BW::Vector4 & color )
{
	color4_.x = color.x;
	color4_.y = color.y;
	color4_.z = color.z;
...
void TestPage::getColor4( BW::Vector4 * color ) const
{
	color->x = color4_.x;
	color->y = color4_.y;
	color->z = color4_.z;
