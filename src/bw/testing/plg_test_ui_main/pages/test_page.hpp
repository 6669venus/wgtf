...
private:
	...
	void setVector3( const BW::Vector3 & vec3 );
	void getVector3( BW::Vector3 * vec3 ) const;

	void setVector4( const BW::Vector4 & vec4 );
	void getVector4( BW::Vector4 * vec4 ) const;

	void setColor3( const BW::Vector3 & color );
	void getColor3( BW::Vector3 * color ) const;

	void setColor4( const BW::Vector4 & color );
	void getColor4( BW::Vector4 * color ) const;
