...
#define _DEFINE_TEST_DATA_TYPES_PRE( prefix, dummy )\
	...
	DEFINE_DATA_TYPE( BW::Vector3, vector3, prefix );\
	DEFINE_DATA_TYPE( BW::Vector4, vector4, prefix );\
...
#define _INIT_DATA_PRE( prefix, dummy )\
	...
	, prefix##vector3_( prefix##float_, prefix##float_ / 2.0f, prefix##float_ * 0.3f )\
	, prefix##vector4_( -prefix##float_, -prefix##float_ / 2.0f, -prefix##float_ * 0.3f, prefix##float_ * 0.4f )\
...
#define INIT_COL_PRE_( definitionManger, prefix )\
	...
	INIT_COLLECTION_DATA( definitionManger, BW::Vector3, vector3, prefix );\
	INIT_COLLECTION_DATA( definitionManger, BW::Vector4, vector4, prefix );\
...
EXPOSE( #prefix "BW::Vector3" #postFix, prefix##vector3##postFix##_, MetaGroup( TestObjectCommon::##groupName ) )\
EXPOSE( #prefix "BW::Vector4" #postFix, prefix##vector4##postFix##_, MetaGroup( TestObjectCommon::##groupName ) )\
