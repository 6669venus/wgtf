...
public:
	...
	virtual ObjectHandle getValue(const ReflectedPropertyRootObjectSetter & setter) = 0;
	virtual void setValue(ReflectedPropertyRootObjectSetter & setter, const ObjectHandle & data) = 0;
};
