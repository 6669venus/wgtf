...
#include "generic_plugin_system/test_plugin1/plugin_objects.hpp"
#include "generic_plugin_system/test_plugin1/metadata/plugin_objects.mpp"
#include "generic_plugin_system/test_plugin2/plugin_objects.hpp"
#include "generic_plugin_system/test_plugin2/metadata/plugin_objects.mpp"
#include "generic_plugin_system/unit_test/memory_plugin_context_creator.hpp"


namespace
{
	const wchar_t * s_Plugin1Path = L"plugins/generic_plugin_system_unit_test_plugin1";
	const wchar_t * s_Plugin2Path = L"plugins/generic_plugin_system_unit_test_plugin2";
}
//------------------------------------------------------------------------------
