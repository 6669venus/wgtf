...
public:
	...
	ReflectedProperty<BW::string, TestPropertyObject> stringProperty_;
	ReflectedProperty<BW::wstring, TestPropertyObject> wstringProperty_;
...
public:
	TestPropertyFixture() :
		...
		stringProperty_("string", &TestPropertyObject::string_, TypeId::getType< BW::string >()),
		wstringProperty_("wstring", &TestPropertyObject::wstring_, TypeId::getType< BW::wstring >()),
...
public:
	...
	typedef std::vector<BW::string> StringVector;
