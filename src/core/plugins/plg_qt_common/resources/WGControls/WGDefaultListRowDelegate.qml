...
//TODO: Delete this control it's made obsolete by WGListView
//

/*!
    \brief Default row in WGMultiColumnListView made obsolete by WGListView.
    Documentation incomplete due to obsolete status
*/

Item {
    id: rowDelegate
    objectName: "WGDefaultListRowDelegate"
