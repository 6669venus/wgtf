...
bool PvpRankedPanel::createPythonObjects()
{
...
void PvpRankedPanel::destroyPythonObjects()
{
...
bool PvpRankedPanel::createDataModel( IComponentContext & context )
{
	auto pDefinitionManager = this->get< IDefinitionManager >();
	if (pDefinitionManager == nullptr)
	{
...
void PvpRankedPanel::destroyDataModel()
{
	auto pDefinitionManager = this->get< IDefinitionManager >();
	if (pDefinitionManager == nullptr)
	{
...
bool PvpRankedPanel::addPanel()
{
	...
	PvpRankedPanelView_ = uiFramework.createView(
		"MapsSettings/PvpRankedPanel.qml",
		IUIFramework::ResourceType::Url,
		contextObject_ );
	uiApplication.addView( *PvpRankedPanelView_ );
...
void PvpRankedPanel::removePanel()
{
	...
	uiApplication->removeView( *PvpRankedPanelView_ );
}
