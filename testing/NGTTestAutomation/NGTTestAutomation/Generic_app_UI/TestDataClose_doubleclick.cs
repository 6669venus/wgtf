...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The TestDataClose_doubleclick recording.
    /// </summary>
    [TestModule("c4eaf583-d2e1-4a57-b9c3-030e98f51787", ModuleType.Recording, 1)]
    public partial class TestDataClose_doubleclick : ITestModule
    {
        /// <summary>
        ...
        static TestDataClose_doubleclick instance = new TestDataClose_doubleclick();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public TestDataClose_doubleclick()
        {
        }
        ...
        /// </summary>
        public static TestDataClose_doubleclick Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Menu.TestData.Close' at Center.", repo.Menu.TestData.CloseInfo, new RecordItemIndex(1));
            repo.Menu.TestData.Close.Click();
            Delay.Milliseconds(200);
