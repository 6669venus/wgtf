...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Close_GenericApp_demo recording.
    /// </summary>
    [TestModule("d99ac968-d85e-4092-9b1a-5a85aa8e9780", ModuleType.Recording, 1)]
    public partial class Close_GenericApp_demo : ITestModule
    {
        /// <summary>
        ...
        static Close_GenericApp_demo instance = new Close_GenericApp_demo();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Close_GenericApp_demo()
        {
        }
        ...
        /// </summary>
        public static Close_GenericApp_demo Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Host.Local.CloseApplication(repo.Generic_app.MainWindow.Self, new Duration(0));
